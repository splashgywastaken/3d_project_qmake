...
bool CustomGLWidget::m_transparent;
    ...
    : QOpenGLWidget(parent)
{
    ...
    if (CustomGLWidget::m_transparent) {
...
void CustomGLWidget::initializeGL()
{
    ...
    connect(context(), &QOpenGLContext::aboutToBeDestroyed, this, &CustomGLWidget::cleanup);

    initializeOpenGLFunctions();
    glClearColor(242, 215, 217, m_transparent ? 0 : 1);
...
void CustomGLWidget::setupVertexAttributes()
{
    m_logoVbo.bind();
